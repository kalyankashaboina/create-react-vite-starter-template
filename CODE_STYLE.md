...
-   **Clarity Over Cleverness:** Code should be immediately understandable. If a piece of logic is inherently complex, it must be accompanied by comments explaining the *why*, not the *what*.
